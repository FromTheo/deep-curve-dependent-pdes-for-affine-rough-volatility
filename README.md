...
- an Adams scheme to solve the fractional Riccati-Volterra equation and compute the characteric function in the rough Heston model, - a backward algorithm (BSDE-inspired) to price an european option in afine rough volatility models. 
